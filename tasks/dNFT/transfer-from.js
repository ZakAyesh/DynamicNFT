...
task("transfer-from", "transfer from a given address to another address")
  .addParam(
    "contract",
    "The address of the dNFT contract that you want to read"
  )
  .addParam("from", "your address with a dNFT")
  .addParam("to", "the address to send your dNFT")
  .addParam("tokenid", "the tokenId of the dNFT being transferred")
  .setAction(async (taskArgs) => {
    const contractAddr = taskArgs.contract;
    const networkId = network.name;
    console.log("Transferring token on ", networkId);
    const dNFT_ABI = [
    ...
    //Create connection to dNFT Contract and call the transfer function
